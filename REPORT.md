...
De **map/kaart van Europa** wordt enkel zelf beïnvloed door de slider van de bar chart. Een **on click** functie zorgt ervoor dat de multi-series line chart wordt geüpdatet: de naam van het land wordt in de titel gezet en de lijn van het land wordt gehighlight. De mouseover en mouseout events laten, net als bij de bar chart, de tooltip zien. Deze weergeeft het land en het energieverbruik gedurende dat hele jaar.
...
1. Over de lijn: weergeeft het land.
2. Over de cirkels: weergeeft de productie van energie via een specifieke 
...
Dit gebeurt bijvoorbeeld nadat er een verandering in de slider — bevindt zich in project/code/js/d3-simple-slider.js — wordt gedetecteerd, of als er op een interactieve button wordt geklikt. De waarde uit het desbetreffende interactieve element wordt dan in een globaal-toegankelijke variabele geüpdatet, en daarna wordt er een **update** functie aangeroepen die gebruik maakt van die globaal-toegankelijke variabele.
